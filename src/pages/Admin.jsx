  ...
  return (
    <main className="page admin-dashboard">
      ...
      {/* ── Acesso rápido: páginas públicas do campeonato ─────────────────────
          Admin pode abrir as páginas mesmo com módulos desligados (Tabela,
          Elenco, etc.). Útil pra testar em campeonato sem expor publicamente. */}
      {campeonatoId && (
        <div style={{
          ...
          {[
            ...
            { label: '🗺 Pick Mapas', path: '/map-pick-admin' },
          ].map(({ label, path }) => (
            <a
              key={label}
          ...
          <section className="admin-section">
            ...
            <div className="admin-fields">
              ...
              <div className="admin-number-field">
                <div className="admin-toggle-label">Volume dos sons</div>
